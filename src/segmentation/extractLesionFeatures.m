...
%   DETECTDARKLESIONS, DETECTNEOVASCULARIZATION.
    ...
    F.softExudates = struct('areaDD2', ex.softAreaDD2, 'count', ex.softCount);
...
%   silently teach it that ungradable images are healthy.
    ...
    F.microaneurysms = struct('count', NaN, 'countWithin1DD', NaN, ...
        'densityPerDD2', NaN, 'meanRadiusDD', NaN);
    F.haemorrhages = struct('count', NaN, 'areaDD2', NaN, 'largestAreaDD2', NaN, ...
        'countByType', struct('dot', NaN, 'blot', NaN, 'flame', NaN));
    F.hardExudates = struct('areaDD2', NaN, 'count', NaN, ...
        'minDistanceToFoveaDD', NaN, 'areaWithin1DDofFovea', NaN);
    F.softExudates = struct('areaDD2', NaN, 'count', NaN);
