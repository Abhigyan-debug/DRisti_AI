...
%   See also SIMULATE_DISTRICT_THROUGHPUT, RUN_DISTRICT_SCENARIO_ANALYSIS.
    ...
    params.targetPatientsPerDay    = params.annualScreeningTarget / params.operatingDaysPerYear; % 400 pts/day
    ...
    params.totalCameras            = params.numPHCs + params.numVans; % 44 total acquisition points
    ...
    params.totalPayloadMB          = params.imagesPerPatient * params.rawImageMegabytes; % 14 MB/patient
    ...
    params.aiTotalLatencySec       = params.imagesPerPatient * params.aiInferenceLatencySec; % ~0.48 s/pt
    ...
    % Expected average review time across clinical population is ~22.6 seconds (< 30s target!)
end
